...
- `outputs/plots/temporal_compare_family_a_attack_test_01.png`
- `outputs/plots/temporal_compare_family_a_attack_test_02.png`
- `outputs/plots/temporal_compare_family_b_attack_test_01.png`
- `outputs/plots/temporal_compare_family_b_attack_test_02.png`
- `outputs/tables/temporal_comparison_summary.csv`
- `outputs/tables/temporal_comparison_summary.md`

How they were produced:

These plots are generated by `python temporal_compare.py`. The script selects the best online/windowed model for each family using test window F1 from `outputs/results_{family}.json`. It intentionally excludes Bag RBF because Bag RBF aggregates the whole 15-minute capture and is not a streaming window detector.
...
- Blue line: Quantum ZZ maximum IP-instance score per window.
- Green line: best online model maximum IP-instance score per window.
- Blue dashed threshold: Quantum ZZ calibrated threshold.
- Green dotted threshold: best online model threshold.
- Orange triangles: Quantum ZZ predicted attack windows.
